...
temp =-------黒ボタンが押されました。------`n`n
temp =%temp%                 %A_YYYY%`/%a_mon%`/%a_mday%%weekd%`n`n
temp =%temp%      帰宅したときのチェックリスト`n`n`n
temp =%temp%	□車のゴミを捨てる（週に1度）`n`n
temp =%temp%　　　　□領収書片付け→おくる`n`n
temp =%temp%　　　　□財布かたづけ`n`n
temp =%temp%　　　　□歩数計を取り出す`n`n
temp =%temp%　　　　□水筒を用意`n`n
temp =%temp%　　　　□部屋の片付け`n`n
temp =%temp%　　　　※＿＿＿＿＿＿＿＿＿＿＿＿＿＿`n`n`n
temp =%temp%　　　　□車の重要な書類を下ろしておく`n`n
